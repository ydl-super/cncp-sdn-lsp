...
type SRv6GlobalDescriptor struct {
	...
	ValueComparator      func(key string, oldValue, newValue *linux_srv6.SRv6Global) bool
	NBKeyPrefix          string
	WithMetadata         bool
	MetadataMapFactory   MetadataMapFactory
	Validate             func(key string, value *linux_srv6.SRv6Global) error
	Create               func(key string, value *linux_srv6.SRv6Global) (metadata interface{}, err error)
	Delete               func(key string, value *linux_srv6.SRv6Global, metadata interface{}) error
	Update               func(key string, oldValue, newValue *linux_srv6.SRv6Global, oldMetadata interface{}) (newMetadata interface{}, err error)
	UpdateWithRecreate   func(key string, oldValue, newValue *linux_srv6.SRv6Global, metadata interface{}) bool
	Retrieve             func(correlate []SRv6GlobalKVWithMetadata) ([]SRv6GlobalKVWithMetadata, error)
	IsRetriableFailure   func(err error) bool
	DerivedValues        func(key string, value *linux_srv6.SRv6Global) []KeyValuePair
	Dependencies         func(key string, value *linux_srv6.SRv6Global) []Dependency
...
func castSRv6GlobalValue(key string, value proto.Message) (*linux_srv6.SRv6Global, error) {
	typedValue, ok := value.(*linux_srv6.SRv6Global)
	if !ok {
