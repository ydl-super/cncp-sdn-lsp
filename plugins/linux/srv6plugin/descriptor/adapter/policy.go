...
type PolicyDescriptor struct {
	...
	ValueComparator      func(key string, oldValue, newValue *linux_srv6.Policy) bool
	NBKeyPrefix          string
	WithMetadata         bool
	MetadataMapFactory   MetadataMapFactory
	Validate             func(key string, value *linux_srv6.Policy) error
	Create               func(key string, value *linux_srv6.Policy) (metadata interface{}, err error)
	Delete               func(key string, value *linux_srv6.Policy, metadata interface{}) error
	Update               func(key string, oldValue, newValue *linux_srv6.Policy, oldMetadata interface{}) (newMetadata interface{}, err error)
	UpdateWithRecreate   func(key string, oldValue, newValue *linux_srv6.Policy, metadata interface{}) bool
	Retrieve             func(correlate []PolicyKVWithMetadata) ([]PolicyKVWithMetadata, error)
	IsRetriableFailure   func(err error) bool
	DerivedValues        func(key string, value *linux_srv6.Policy) []KeyValuePair
	Dependencies         func(key string, value *linux_srv6.Policy) []Dependency
...
func castPolicyValue(key string, value proto.Message) (*linux_srv6.Policy, error) {
	typedValue, ok := value.(*linux_srv6.Policy)
	if !ok {
