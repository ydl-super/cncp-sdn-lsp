...
import (
	...
	hipplugin "go.pantheon.tech/stonework/plugins/hip"
	isisxplugin "go.pantheon.tech/stonework/plugins/isisx"
	linux_srv6plugin "go.pantheon.tech/stonework/plugins/linux/srv6plugin"
...
type Linux struct {
	...
	SRv6Plugin     *linux_srv6plugin.SRv6Plugin
}
...
func DefaultLinux() Linux {
	return Linux{
		...
		SRv6Plugin:     &linux_srv6plugin.DefaultPlugin,
	}
}

type Hip struct {
	Hipv2Plugin *hipplugin.Hipv2Plugin
}

func DefaultHip() Hip {
	return Hip{
		Hipv2Plugin: &hipplugin.DefaultPlugin,
	}
}
